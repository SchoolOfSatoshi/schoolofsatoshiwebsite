...
export default function VideosPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden bg-background">
      ...
      <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-amber-50/70 via-white/80 to-white dark:from-background dark:via-background/90 dark:to-background/50">
        {/* Decorative elements */}
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="inline-block p-1.5 px-4 bg-primary/10 rounded-full text-sm font-medium text-primary mb-3 animate-pulse-slow">
              All Series
            </div>
            <div className="space-y-2 max-w-3xl mx-auto">
              <h1 className="text-4xl font-heading font-bold tracking-tighter sm:text-5xl md:text-6xl/tight text-primary animate-slide-up">
                Bitcoin Kiboozi Videos
              </h1>
              <p className="max-w-[700px] text-muted-foreground md:text-xl animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" className="w-full h-auto fill-background">
      ...
      <section className="w-full py-2 md:py-2 lg:py-2">
        <div className="container px-4 md:px-6">
            ...
            <TabsContent value="all" className="space-y-12 transition-all duration-500 ease-in-out">
              <div className="grid md:grid-cols-2 gap-8">
                {videos.map((video, index) => (
                  ...
                  >
                    <Card className="overflow-hidden border-none shadow-xl rounded-2xl h-full glass-card hover:shadow-2xl transition-all duration-300">
                      <CardContent className="p-0">
                        <div className="relative aspect-video">
                          ...
                          >
                            <div className={`
                              ...
                              ${hoveredVideo === video.id ? 'bg-primary scale-110' : 'bg-white scale-100'} 
                              w-16 h-16 transition-all duration-300 shadow-lg group-hover:scale-110
                            `}>
                              <Play
                                className={`
                                  ${hoveredVideo === video.id ? 'text-white translate-x-0.5' : 'text-primary'} 
                        ...
                        <div className="p-6 bg-card/50 backdrop-blur-sm">
                          <h3 className="text-xl font-heading font-bold mb-3 line-clamp-2 text-foreground group-hover:text-primary transition-colors">{video.title}</h3>
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center text-primary hover:text-orange-600 font-medium transition-colors duration-300 group"
                          >
                            Watch full video
          ...
          <div className="flex justify-center mt-16 pb-20">
            ...
            >
              <Button
                className="bg-primary hover:bg-orange-600 text-white px-8 py-6 h-auto text-lg font-medium rounded-full shadow-lg transition-all duration-300 relative z-10 overflow-hidden group-hover:shadow-orange-300/30"
              >
              ...
              <div className="absolute -inset-1 bg-gradient-to-br from-orange-400 via-primary to-amber-500 rounded-full opacity-70 blur-sm group-hover:opacity-100 transition-opacity duration-500"></div>
            </a>
          </div>
        </div>
      </section>
