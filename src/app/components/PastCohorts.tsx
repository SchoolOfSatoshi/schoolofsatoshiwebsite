...
const PastCohorts: React.FC = () => {
  ...
  return (
    ...
    <section className="py-10 bg-gradient-to-br from-[#FCF6E8] to-[#FFF4E0]">
  ...
  //       Explore our journey and the impact of our blockchain education programs
  //     </p>
  //   </div>

  //   {/* Carousel Wrapper */}
  //   <div className="relative flex items-center justify-center mt-4 h-[500px]">
  //     <AnimatePresence mode="wait">
  //       {cohorts.map((cohort, index) =>
  //         index === currentCohort ? (
  //           <motion.div
  ...
  // </section>
    ...
    // <section className="py-16 bg-gradient-to-br from-[#FCF6E8] to-[#FFF4E0]">
    //   <h2 className="flex justify-between items-center mb-12 text-4xl font-bold text-gray-900">Past Cohorts</h2>
